...
sr.reveal('.order__tooltip-1', { delay: 800, origin: 'left' })
sr.reveal('.order__tooltip-2', { delay: 800, origin: 'right' })
...
sr.reveal('.contact__img-1', { delay: 1000, distance: 0, rotate: { z: -45 } })
sr.reveal('.contact__img-2', { delay: 1200, distance: 0, rotate: { z: 45 } })
sr.reveal('.contact__dam-1', { delay: 1400, distance: 0, rotate: { z: 45 } })
...
// ADD THIS TO TEST GIT VERSION 12